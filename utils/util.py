...
def sampling(net, size, diffusion_hyperparams, cond, mask, only_generate_missing=0, guidance_weight=0):
    ...
    with torch.no_grad():
        for t in range(T - 1, -1, -1):
            ...
            epsilon_theta,_ = net((x, cond, mask, diffusion_steps,))  # predict \epsilon according to \epsilon_\theta
...
def training_feature(net, X, diffusion_hyperparams, only_generate_missing=1):
    """
    Compute the training loss of epsilon and epsilon_theta
